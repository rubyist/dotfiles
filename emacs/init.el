...
(custom-set-variables
 ...
 '(elfeed-feeds
   (quote
    ("https://blog.lostartpress.com/feed/" "http://wpatrickedwards.blogspot.com/feeds/posts/default" "http://feeds.feedburner.com/PatriceLejeune?format=xml" "http://lumberjocks.com/shipwright/blog/feed" "http://lumberjocks.com/TungOil/blog/feed" "http://donsbarn.com/feed/")))
 '(go-impl-aliases-alist (quote (("hh" . "http.Handler") ("irw" . "io.ReadWriter"))))
 '(package-selected-packages
   (quote
    (dracula-theme elfeed telephone-line nhexl-mode ggtags helm-gtags paredit ob-restclient restclient ob-http flycheck-gometalinter ox-gfm wsd-mode indicators go-impl htmlize rjsx-mode rainbow-delimiters deft color-theme-sanityinc-tomorrow markdown-mode projectile protobuf-mode noflet magit go-guru undo-tree linum-relative popwin go-add-tags yasnippet flycheck htmilize ox-reveal zenburn-theme which-key use-package try org-edna org-bullets counsel color-theme badger-theme auto-complete ace-window)))
